ymaps.ready(function () {
    var myMap = new ymaps.Map("map", {
        ...
        myPlacemarkWithContent = new ymaps.Placemark(
            ...
            {
                balloonContentBody:
                    '<img src="/assets/images/logo.svg" width="140" class="mx-auto"> <br/> ' +
                    '<a class="text-center block" href="tel:+7-916-263-49-11">+7 (916) 263-49-11</a>' +
                    '<a class="text-center block" href="tel:+7-916-263-49-11">+7 (916) 263-49-11</a>' +
                    '<p class="text-gray-400 text-center">Пушкино , мкр. Серебрянка , д.48, к. 2</p>',
                hintContent: "Лаборатория «Бонвильский треугольник»",
            },
            {
                iconLayout: "default#imageWithContent",
                balloonShadow: true,
                iconImageHref: "/assets/images/ico.svg",
                iconImageSize: [70, 70],
